export function FeatureHandshake(props: React.SVGProps<SVGSVGElement>) {
  return (
  ...
  <g className="fh_anim-l">
    {/* Arm */}
    <rect x="-4" y="52" width="34" height="16" rx="3" fill="#1E2249" />
    {/* Cuff Detail */}
    <rect x="22" y="51" width="4" height="18" rx="1.5" fill="#3D4578" />
    {/* Palm */}
    <path d="M 26 52 h 16 a 8 8 0 0 1 8 8 v 0 a 8 8 0 0 1 -8 8 h -16 z" fill="#2D3561" stroke="#FFFFFF" strokeWidth="1.5" strokeLinejoin="round" />
  </g>

  {/* Layer 2: Right Arm and Palm */}
  <g className="fh_anim-r">
    {/* Arm */}
    <rect x="90" y="52" width="34" height="16" rx="3" fill="#A87049" />
    {/* Cuff Detail */}
    <rect x="94" y="51" width="4" height="18" rx="1.5" fill="#D49B72" />
    {/* Palm */}
    <path d="M 94 52 h -16 a 8 8 0 0 0 -8 8 v 0 a 8 8 0 0 0 8 8 h 16 z" fill="#C4875B" stroke="#FFFFFF" strokeWidth="1.5" strokeLinejoin="round" />
  </g>

  {/* Layer 3: Left Thumb (Overlaps Right Palm slightly) */}
  <g className="fh_anim-l">
    <rect x="40" y="41" width="10" height="16" rx="5" transform="rotate(35 45 49)" fill="#3D4578" stroke="#FFFFFF" strokeWidth="1.5" />
  </g>

  {/* Layer 4: Right Thumb (Overlaps Left Palm and Thumb) */}
  <g className="fh_anim-r">
    <rect x="70" y="41" width="10" height="16" rx="5" transform="rotate(-35 75 49)" fill="#D49B72" stroke="#FFFFFF" strokeWidth="1.5" />
  </g>

  {/* Meeting Point Sparkle */}
  <path className="fh_sparkle" d="M 60 40 Q 60 48 68 48 Q 60 48 60 56 Q 60 48 52 48 Q 60 48 60 40 Z" fill="#C4875B" />
</svg>
  );
}
