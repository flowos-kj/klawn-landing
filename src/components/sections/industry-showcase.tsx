...
const USE_CASES: UseCase[] = [
  // 건설
  {
    id: "con-1", industry: "construction", company: "서울 종합건설 A사", department: "구매조달팀",
    description: "반포 현장 철근 1,500톤 발주서 자동 생성",
    ...
    pipeline: ["ERP 톤당 ₩880K 조회", "발주서 13.2억 생성", "초고액 감지", "복수 결재 상신"],
    svgPath: "/industries/construction/1-구매조달팀.svg",
    staticPath: "/industries/static/construction/1-구매조달팀.svg",
  },
  {
    id: "con-2", industry: "construction", company: "인천 주상복합건설 B사", department: "품질안전팀",
    description: "송도 현장 감리 지적 4건 → 조치계획 엑셀 변환",
    ...
    pipeline: ["감리 PDF 4건 파싱", "조치계획 엑셀 생성", "드라이브 업로드", "협력사 메일 발송"],
    svgPath: "/industries/construction/2-품질안전팀.svg",
    staticPath: "/industries/static/construction/2-품질안전팀.svg",
  },
  {
    id: "con-3", industry: "construction", company: "경기 종합건설 C사", department: "기획팀",
    description: "토목 협력사 20개사 나이스 신용등급 일괄 평가",
    ...
    pipeline: ["ERP 거래처 20사 조회", "나이스 신용 API", "법인정보 마스킹", "C등급 하도급 제한"],
    svgPath: "/industries/construction/3-기획팀.svg",
    staticPath: "/industries/static/construction/3-기획팀.svg",
  },
  {
    id: "con-4", industry: "construction", company: "경기 물류건설 D사", department: "법무팀",
    description: "평택 산재 합의서 8천만 원 AI 검토 → 임원 회의",
    ...
    pipeline: ["합의서 한글 파싱", "보상 규정 검증", "신뢰도 60% 경고", "임원 회의 캘린더"],
    svgPath: "/industries/construction/4-법무팀.svg",
    staticPath: "/industries/static/construction/4-법무팀.svg",
  },
  {
    id: "con-5", industry: "construction", company: "경기 주택건설 E사", department: "현장인사팀",
    description: "광명 현장 145명 노임대장 게이트 교차검증",
    ...
    pipeline: ["ERP 노임대장 조회", "게이트 공수 교차검증", "외국인등록번호 마스킹", "₩3,250만 결재"],
    svgPath: "/industries/construction/5-현장인사팀.svg",
    staticPath: "/industries/static/construction/5-현장인사팀.svg",
  },
  // 금융
  {
    id: "fin-1", industry: "finance", company: "서울 손해보험 A사", department: "고객지원팀",
    description: "자동차보험 보상 지연 VOC 추출과 센터장 독촉",
    ...
    pipeline: ["CRM VOC 추출", "PII 92건 마스킹", "보상시스템 교차검증", "위하고 독촉 발송"],
    svgPath: "/industries/finance/1-고객지원팀.svg",
    staticPath: "/industries/static/finance/1-고객지원팀.svg",
  },
  {
    id: "fin-2", industry: "finance", company: "서울 생명보험 B사", department: "법무팀",
    description: "실손보험 약관 3.2조 신·구 비교 → 법무법인 자문",
    ...
    pipeline: ["약관 PDF 비교분석", "신뢰도 78% 경고", "위험 조항 감지", "법무법인 메일 초안"],
    svgPath: "/industries/finance/2-법무팀.svg",
    staticPath: "/industries/static/finance/2-법무팀.svg",
  },
  {
    id: "fin-3", industry: "finance", company: "서울 화재해상보험 C사", department: "상품기획팀",
    description: "K손보 펫보험 경쟁 분석 → 경영진 PT 생성",
    ...
    pipeline: ["K손보 웹 검색", "자사 상품 ERP 조회", "보장 항목 비교", "경영진 PPT 생성"],
    svgPath: "/industries/finance/3-상품기획팀.svg",
    staticPath: "/industries/static/finance/3-상품기획팀.svg",
  },
  {
    id: "fin-4", industry: "finance", company: "서울 손해보험 D사", department: "법인영업팀",
    description: "H물산 30억 단체보험 수주 공지 → 본부장 결재",
    ...
    pipeline: ["위하고 수주 공지", "ERP 30억 매출 등록", "고액 계약 감지", "본부장 실적 결재"],
    svgPath: "/industries/finance/4-법인영업팀.svg",
    staticPath: "/industries/static/finance/4-법인영업팀.svg",
  },
  {
    id: "fin-5", industry: "finance", company: "서울 캐피탈 E사", department: "IT보안팀",
    description: "주말 망분리 예외 8건 추출 → 새벽 비인가 차단",
    ...
    pipeline: ["VPN 로그 8건 추출", "인사 예외 교차검증", "IP·사번 마스킹", "CISO 소명 결재"],
    svgPath: "/industries/finance/5-IT보안팀.svg",
    staticPath: "/industries/static/finance/5-IT보안팀.svg",
  },
  // 헬스케어
  {
    id: "hc-1", industry: "healthcare", company: "경기 바이오제약 A사", department: "연구개발본부",
    description: "당뇨 신약 임상 3상 HbA1c 분석 → 한글 리포트",
    ...
    pipeline: ["드라이브 CSV 다운", "HbA1c -1.2% 분석", "기밀 HWPX 생성", "위하고 내게쓰기"],
    svgPath: "/industries/healthcare/1-연구개발본부.svg",
    staticPath: "/industries/static/healthcare/1-연구개발본부.svg",
  },
  {
    id: "hc-2", industry: "healthcare", company: "서울 의료기기 B사", department: "영업기획팀",
    description: "병원 30곳 리베이트 방지(CP) 서약서 일괄 발송",
    ...
    pipeline: ["ERP 병원 30곳 조회", "CP 서약서 PDF 30건", "Gmail 일괄 초안", "컴플라이언스 결재"],
    svgPath: "/industries/healthcare/2-영업기획팀.svg",
    staticPath: "/industries/static/healthcare/2-영업기획팀.svg",
  },
  {
    id: "hc-3", industry: "healthcare", company: "충북 제약 C사", department: "마케팅팀",
    description: "제주 심포지엄 의사 45명 식대 김영란법 검증",
    ...
    pipeline: ["의사 45명 엑셀 파싱", "면허번호 마스킹", "1인 10만 한도 검증", "ERP ₩450만 전표"],
    svgPath: "/industries/healthcare/3-마케팅팀.svg",
    staticPath: "/industries/static/healthcare/3-마케팅팀.svg",
  },
  {
    id: "hc-4", industry: "healthcare", company: "대전 바이오텍 D사", department: "재무팀",
    description: "복지부 연구비 240건 분석 → 부적합 계정 탐지",
    ...
    pipeline: ["집행내역 240건 파싱", "신뢰도 55% 경고", "직접비→간접비 감지", "ERP 계정 이관"],
    svgPath: "/industries/healthcare/4-재무팀.svg",
    staticPath: "/industries/static/healthcare/4-재무팀.svg",
  },
  {
    id: "hc-5", industry: "healthcare", company: "충북 원료의약품 E사", department: "품질관리팀",
    description: "오송공장 페니실린 6개월 GMP 기록 식약처 제출",
    ...
    pipeline: ["ERP/MES 6개월 조회", "LIMS OOS 교차검증", "사번 비식별화 PDF", "공장장 결재 상신"],
    svgPath: "/industries/healthcare/5-품질관리팀.svg",
    staticPath: "/industries/static/healthcare/5-품질관리팀.svg",
  },
  // 제조
  {
    id: "mfg-1", industry: "manufacturing", company: "경기 자동차부품 A사", department: "생산관리팀",
    description: "화성공장 A·B라인 수율 99% 주간 리포트 생성",
    ...
    pipeline: ["MES A·B라인 조회", "HWPX 주간보고 생성", "드라이브 업로드"],
    svgPath: "/industries/manufacturing/1-생산관리팀.svg",
    staticPath: "/industries/static/manufacturing/1-생산관리팀.svg",
  },
  {
    id: "mfg-2", industry: "manufacturing", company: "경기 정밀기계 B사", department: "영업팀",
    description: "현대향 샤프트 ₩45K → ₩47.2K 단가 인상 기안",
    ...
    pipeline: ["ERP ₩45,000 조회", "5% 인상 기안서", "단가변경 감지", "본부장 결재 상신"],
    svgPath: "/industries/manufacturing/2-영업팀.svg",
    staticPath: "/industries/static/manufacturing/2-영업팀.svg",
  },
  {
    id: "mfg-3", industry: "manufacturing", company: "인천 자동차부품 C사", department: "품질관리팀",
    description: "납품처 클레임 규격불량 4건 → 품질개선 태스크",
    detail: "인천 자동차부품 C사 — CRM에서 1개월간 B2B 납품처 클레임을 추출하고 담당자명·연락처 14건을 마스킹합니다. 규격 불량 4건을 분류해 생산기술팀 위하고 '품질개선 프로젝트' 태스크로 자동 생성합니다.",
    pipeline: ["CRM 클레임 추출", "담당자 14건 마스킹", "규격불량 4건 분류", "위하고 태스크 등록"],
    svgPath: "/industries/manufacturing/3-품질관리팀.svg",
    staticPath: "/industries/static/manufacturing/3-품질관리팀.svg",
  },
  {
    id: "mfg-4", industry: "manufacturing", company: "대구 소재부품 D사", department: "재무팀",
    description: "삼원가든 영수증 OCR 금액 불일치 → 사용자 확인",
    ...
    pipeline: ["영수증 OCR 파싱", "신뢰도 72% 경고", "₩145K 사용자 확인", "ERP 매입 전표"],
    svgPath: "/industries/manufacturing/4-재무팀.svg",
    staticPath: "/industries/static/manufacturing/4-재무팀.svg",
  },
  {
    id: "mfg-5", industry: "manufacturing", company: "창원 중공업 E사", department: "인사팀",
    description: "신규입사 12명 연봉계약서 워터마크 PDF 일괄 생성",
    ...
    pipeline: ["ERP·채용 12명 검증", "주민번호 암호화", "워터마크 PDF 12건", "인사팀장 위하고"],
    svgPath: "/industries/manufacturing/5-인사팀.svg",
    staticPath: "/industries/static/manufacturing/5-인사팀.svg",
  },
  // 리테일
  {
    id: "ret-1", industry: "retail", company: "서울 생활유통 A사", department: "물류센터운영팀",
    description: "용인 1센터 생필품 3건 안전재고 미달 → 발주 CSV",
    detail: "서울 생활유통 A사 — 용인 1센터 WMS/ERP에서 생필품 재고를 조회하고, 안전재고 미달 3건(크리넥스 380개, 다우니 155개, 햇반 690개)을 감지합니다. 부족 수량 기준 발주용 CSV를 자동 생성합니다.",
    pipeline: ["WMS 생필품 재고조회", "안전재고 3건 감지", "발주 CSV 생성"],
    svgPath: "/industries/retail/1-물류센터운영팀.svg",
    staticPath: "/industries/static/retail/1-물류센터운영팀.svg",
  },
  {
    id: "ret-2", industry: "retail", company: "서울 온라인커머스 B사", department: "마케팅팀",
    description: "VIP 98,540명 봄 기획전 20% 쿠폰 10만 장 발급",
    ...
    pipeline: ["CRM VIP 98,540명", "쿠폰 10만 장 설정", "4.5억 고액 감지", "본부장 결재 상신"],
    svgPath: "/industries/retail/2-마케팅팀.svg",
    staticPath: "/industries/static/retail/2-마케팅팀.svg",
  },
  {
    id: "ret-3", industry: "retail", company: "경기 대형유통 C사", department: "재무팀",
    description: "법인카드 심야 2건 추출 → 사규 교차검증·소명",
    ...
    pipeline: ["법인카드 의심 2건", "임원 한도 교차검증", "카드번호 마스킹", "소명 요청 감사"],
    svgPath: "/industries/retail/3-재무팀.svg",
    staticPath: "/industries/static/retail/3-재무팀.svg",
  },
  {
    id: "ret-4", industry: "retail", company: "서울 홈쇼핑 D사", department: "총무팀",
    description: "수기 영수증 부가세 오류 감지 → ERP 품의서 생성",
    ...
    pipeline: ["영수증 일괄 OCR", "신뢰도 65% 경고", "부가세 ₩5K 보정", "ERP 품의서 생성"],
    svgPath: "/industries/retail/4-총무팀.svg",
    staticPath: "/industries/static/retail/4-총무팀.svg",
  },
  {
    id: "ret-5", industry: "retail", company: "부산 패션리테일 E사", department: "고객지원팀",
    description: "3개월 반품률 90%+ 블랙컨슈머 5명 계정 정지",
    ...
    pipeline: ["CRM 구매이력 조회", "물류 반품 교차분석", "성명·주소 마스킹", "CS본부장 정지 결재"],
            ...
            {filtered.map((uc, i) => (
              ...
              >
                ...
                <div className="flex flex-1 flex-col p-4">
                  <span className="mb-0.5 text-[11px] font-medium text-copper-dark">
                    {uc.company}
                  </span>
