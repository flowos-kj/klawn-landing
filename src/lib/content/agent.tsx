...
const content: PageContent = {
  ...
  skillsShowcase: {
    heading: "2,243 스킬 — ChatGPT에는 없습니다",
    subheading:
      "Klawn automatically leverages 2,243 skills to solve problems, and when existing skills fall short, it auto-generates new ones on the spot.",
    description:
      "2,243개의 사전 구축 스킬이 에이전트 루프 안에서 자동 실행됩니다. 도구 호출, API 연동, 데이터 파이프라인까지 — ChatGPT의 플러그인과는 차원이 다릅니다.",
    autoGenDescription:
